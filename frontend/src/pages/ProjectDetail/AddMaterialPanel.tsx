    ...
    <div className="card space-y-4 p-4 sm:p-5">
      <div className="flex items-center gap-3">
        <button
          ...
          onClick={onClose}
          aria-label={t('back')}
          className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-[rgb(var(--border-light))] bg-white text-warm-gray transition-colors hover:bg-soft-brown/20 hover:text-ink"
        >
          <FiArrowLeft className="h-[19px] w-[19px]" aria-hidden />
        </button>
        <div className="min-w-0">
          <p className="text-xs font-bold uppercase tracking-[0.1em] text-sand-green-dark">
            {t('add_to_project', { name: projectName })}
          </p>
      ...
      {pane === 'library' ? (
        <div className="space-y-3">
          ...
          {pendingItem && (
            <div className="space-y-2.5 rounded-xl border border-sand-blue/40 bg-sand-blue/5 p-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1.5 border-t border-soft-brown/20 pt-3 text-center">
